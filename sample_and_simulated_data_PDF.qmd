...
A multinomial logistic regression was conducted to examine the combined effects of both temporal and psychological distance on responses to the critical slide.
Overall the model significantly predicted responses to the critical slide
$\chi$^2^(`r chi_df`,
*N* = `r length(x$cs)`) =
`r round(c, digits=2)`,
...
#| apa-cap: Psychological distance and reason-giving for each Scenario
#| include: true
