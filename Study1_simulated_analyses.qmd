...
model1 <- lmerTest::lmer(ju1_2 ~
                ...
                + (1|ResponseId)
                , data = x
                , contrasts = list(temp = contr.sum  , ambiguity = contr.sum)
            )
anova(model1)
summary(model1)
emmeans::emmeans(model1, list(pairwise ~ temp), adjust = "tukey")
emmeans::emmeans(model1, list(pairwise ~ ambiguity), adjust = "tukey")
emmeans::emmeans(model1, list(pairwise ~ temp*ambiguity), adjust = "tukey")
