...
simulated_data_overall_scenario_within_Study1 <- x
...
simulated_data_overall_scenario_within <- simulated_data_overall_scenario_within_Study1
...
simulated_data_scenarios_within_sc_Study1 <- rbind(Heinz,J_and_M,Jennifer,Trolley)

y <- simulated_data_scenarios_within_sc_Study1
...
x$manipulation_check    <- rtruncnorm(n=(length(x$ResponseId)), a=1, b=7, mean=3.9, sd=1.7)
...
simulated_data_scenarios_within_sc_Study1 <- df3
...
rm("conditions", "control", "distant", "near", "df", "dumb", "empty_df", "Heinz", "J_and_M",
   ...
   "reasons", "sample_data", "slf_fut", "slf_now", "Trolley", "x", "y","z")
